...
public class TestHL7Message extends TestCase {
    ...
    private static final String[] SEGMENTS = {
            ...
            "PV2|||||||1||||||||||||||||^^^^^^^^^103", "ROL|1|AD|SAHCP|XXXXXXXXXX^^^^^^S|||||6|1",
            "PR1|1||1||20060705|1", "GT1|1||||||||||||||||||||NOT APPLICABLE" };
    ...
    public void testAddSegmentHL7MessageHL7Segment() {
        ...
        for (String segment : SEGMENTS) {
            HL7Message.addSegment(msg, HL7Parser.parseSegment(segment, DELIMITERS, true));
        }
    ...
    public void testGetEnumerator() {
        ...
        assertNotNull(msg);
        int i = 0;
        for (Enumeration<HL7Segment> e = msg.getEnumerator(); e.hasMoreElements();) {
    ...
    public void testToString() {
        HL7Message msg = HL7Parser.parseMessage(MESSAGE, true);
        assertEquals(MESSAGE.replace("^~\\&", "\\S\\\\R\\\\E\\\\T\\"), msg.toString());
    }
