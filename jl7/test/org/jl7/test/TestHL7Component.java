...
public class TestHL7Component extends TestCase {
     ...
     */
    public void testGet() {
        String[] subComponents = { "abc" + HL7Message.segmentTerminator, "\\|~^&def" };
        component.setSubcomponents(subComponents, "|^~\\&", false);
        HL7Subcomponent subcomponent = component.get(0);
        assertEquals("abc" + HL7Message.segmentTerminator, subcomponent.getValue());
    ...
    public void testSetSubcomponentsEscapes() {
        String[] subComponents = { "abc\\" + HL7Message.segmentTerminator, "\\E\\\\F\\\\R\\\\S\\\\T\\def" };
