...
public class TestHL7Field extends TestCase {
     ...
     */
    public void testGet() {
        String[] repetitions = { "abc" + HL7Message.segmentTerminator, "\\|~^&def" };
        field.setRepetitions(repetitions, "|^~\\&", false);
        HL7FieldRepetition repetition = field.get(0);
        assertEquals("abc" + HL7Message.segmentTerminator, repetition.getValue());
    ...
    public void testSetRepetitionsEscapes() {
        String[] repetitions = { "abc\\" + HL7Message.segmentTerminator, "\\E\\\\F\\\\R\\\\S\\\\T\\def" };
