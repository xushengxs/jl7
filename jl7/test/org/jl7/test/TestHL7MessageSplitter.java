...
public class TestHL7MessageSplitter extends TestCase {
	...
	public void testGetInsurances() {
		...
		assertEquals("PID NK1 PV1 GT1 DG1 IN1 IN2", insurances.get(0)
				.getStructure());
		assertEquals("PID NK1 PV1 GT1 DG1 IN1 IN2", insurances.get(1)
				.getStructure());
		assertEquals("PID NK1 PV1 GT1 DG1 IN1", insurances.get(2)
				.getStructure());
		assertEquals("MEDICARE", Hl7MessageExtractor.ExtractString(insurances
				.get(0), "IN1|4"));
		assertEquals("MEDICAL MUTUAL CALIF.", Hl7MessageExtractor
				.ExtractString(insurances.get(1), "IN1|4"));
		assertEquals("SELF PAY", Hl7MessageExtractor.ExtractString(insurances
				.get(2), "IN1|4"));
	}
