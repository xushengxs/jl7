...
public class HL7FieldRepetition {
    ...
    public void setComponents(String[] components, String delimiters, boolean escapesInSubcomponents) {
        for (String component : components) {
            this.components.add(HL7Parser.parseComponent(component, delimiters, escapesInSubcomponents));
        }
    }
    ...
    public void setComponentsWithoutDelimiters(String hl7String) {
        components.add(HL7Parser.parseComponentWithoutDelimiters(hl7String));
    }
