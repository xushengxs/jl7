...
public class HL7Subcomponent {
    ...
    public void setEscapedValue(String hl7String, String delimiters) {
        ...
        value = value.replace("" + escapeCharacter + segmentTerminator, "" + segmentTerminator);
        value = value.replace("" + escapeCharacter + fieldSeparator, "" + fieldSeparator);
        value = value.replace("" + escapeCharacter + repetitionSeparator, "" + repetitionSeparator);
        value = value.replace("" + escapeCharacter + componentSeparator, "" + componentSeparator);
        value = value.replace("" + escapeCharacter + subcomponentSeparator, "" + subcomponentSeparator);
    ...
    public String toString() {
        ...
        value = value.replace("" + segmentTerminator, "" + escapeCharacter + segmentTerminator);
        return value;
    }
