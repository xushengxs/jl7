...
public class HL7Component {
	 ...
	 * @since 0.1
	 */
	public void setSubcomponents(String[] subComponents, String delimiters,
			boolean escapesInSubcomponents) {
		for (String subComponent : subComponents) {
			this.subcomponents.add(HL7Parser.parseSubcomponent(subComponent,
	...
	public void setSubcomponentsWithoutDelimiters(String hl7String) {
		this.subcomponents.add(HL7Parser
				.parseSubcomponentWithoutDelimiters(hl7String));
	}
