...
public class HL7Field {
    ...
    public void setRepetitions(String[] repetitions, String delimiters, boolean escapesInSubcomponents) {
        for (String repetition : repetitions) {
            this.repetitions.add(HL7Parser.parseFieldRepetition(repetition, delimiters, escapesInSubcomponents));
        }
    }
    ...
    public void setRepetitionsWithoutDelimiters(String hl7String) {
        repetitions.add(HL7Parser.parseFieldRepetitionWithoutDelimiters(hl7String));
    }
