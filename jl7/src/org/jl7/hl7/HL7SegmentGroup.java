...
public class HL7SegmentGroup implements Iterable<HL7Segment> {
     ...
     * @since 0.1
     */
    public static List<HL7SegmentGroup> getSegmentGroups(String segmentType, List<HL7Segment> segmentList) {
     ...
     * @since 0.1
     */
    public List<HL7Segment> getAllSegmentsBeforeTypeExceptHeader(String segmentType) {
